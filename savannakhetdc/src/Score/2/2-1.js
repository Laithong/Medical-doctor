...
class Score11 extends React.Component {
	...
	fetchAllRecords = () => {
		...
		fetch("https://dockterapilao.herokuapp.com/C2269DF324/1", {
			method: "GET",
			headers: headers,
		})
                   ...
                   <Grid><br />
                      <Container>
                        <div >
                          ...
                          <p class="laicenter text-lg font-semibold text-gray-700">ຄະແນນ <br />ນັກສຶກສາປີ2 ພາກຮຽນ1</p>
                         </div>                    
                       </Container>
                       <Container>
...
class PScore11 extends React.Component {
	render() {
	  return (
		<div>
      ...
      <Title />      
		  ...
		  <Score11 ref={el => (this.componentRef = el)} />
      </Grid>
		</div>
	  );
	}
